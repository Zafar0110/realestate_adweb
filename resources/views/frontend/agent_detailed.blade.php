                            ...
                            <div class="agent-details hover-img effec-overlay mb-48">
                                <div class="image-wrap ">
                                    <a href="agents-details.html">
                                        <img class="lazyload" data-src="{{ asset('assets/images/section/agent-details.jpg') }}"
                                            src="{{ asset('assets/images/section/agent-details.jpg') }}" alt="">
                                    </a>
                                ...
                                <div class="content-inner">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="text-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                            ...
                                            ut
                                            purus bibendum </p>
                                        <a href="blog-single.html" class="tf-btn-link ">
                                            <span>
                                                Read More
                        ...
                        <div class="col-lg-4 ">
                            <div class="tf-sidebar">
                                ...
                                <div class="sidebar-item sidebar-featured style-2  pb-36 mb-28">
                                    ...
                                    <ul>
                                        <li class="box-listings style-2 hover-img">
                                            <div class="image-wrap">
                                                <img class="lazyload" data-src="{{ asset('assets/images/section/box-listing-1.jpg') }} "
                                                    src="{{ asset('assets/images/section/box-listing-1.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                        ...
                                        <li class="box-listings style-2 hover-img">
                                            <div class=" image-wrap">
                                                <img class="lazyload" data-src="{{ asset('assets/images/section/box-listing-2.jpg') }}"
                                                    src="{{ asset('assets/images/section/box-listing-2.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                                <div class="text-1 title fw-5 lh-20">
                                                    <a href="property-detail-v1.html">Casa Lomas de Machalí Machas</a>
                                        ...
                                        <li class="box-listings style-2 hover-img">
                                            <div class=" image-wrap">
                                                <img class="lazyload" data-src="{{ asset('assets/images/section/box-listing-3.jpg') }}"
                                                    src="{{ asset('assets/images/section/box-listing-3.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                                <div class="text-1 title fw-5 lh-20">
                                                    <a href="property-detail-v1.html">Casa Lomas de Machalí Machas</a>
                                        ...
                                        <li class="box-listings style-2 hover-img">
                                            <div class=" image-wrap">
                                                <img class="lazyload" data-src="{{ asset('assets/images/section/box-listing-4.jpg') }}"
                                                    src="{{ asset('assets/images/section/box-listing-4.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                                <div class="text-1 title fw-5 lh-20">
                                                    <a href="property-detail-v1.html">Casa Lomas de Machalí Machas</a>
                                        ...
                                        <li class="box-listings style-2 hover-img">
                                            <div class=" image-wrap">
                                                <img class="lazyload" data-src="{{ asset('assets/images/section/box-listing-5.jpg') }}"
                                                    src="{{ asset('assets/images/section/box-listing-5.jpg') }}" alt="">
                                            </div>
                                            <div class="content">
                                                <div class="text-1 title fw-5 lh-20">
                                                    <a href="property-detail-v1.html">Casa Lomas de Machalí Machas</a>
                                ...
                                <div class=" sidebar-ads">
                                    <div class="image-wrap">
                                        <img class="lazyload" data-src="{{ asset('assets/images/blog/ads.jpg') }} " src="{{ asset('assets/images/blog/ads.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="logo relative z-5">
                                        <img src="{{ asset('assets/images/logo/logo-2%402x.png') }} " alt="">
                                    </div>
