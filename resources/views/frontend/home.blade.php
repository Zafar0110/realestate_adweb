        ...
        <div class="main-content ">
            ...
            <section class="tf-spacing-1 section-categories pb-0">
                <div class="tf-container">
                    <div class="heading-section text-center mb-48">
                        <h2 class="title split-text effect-right">Try Searching For</h2>
                        <p class="text-1 split-text split-lines-transform">Thousands of luxury home enthusiasts just
                            like you have found their
                            dream home
                        </p>
                    </div>
                    <div class="wrap-categories-sw">
                        <div class="swiper sw-layout style-pagination" data-preview="6" data-tablet="4"
             ...
             <section class="section-popular-searches tf-spacing-1">
                <div class="tf-container md">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center mb-48">
                                <h2 class="title split-text effect-right">Popular Searches</h2>
                            ...
                            <div class="widget-tabs style-2 ">
                                <ul class="widget-menu-tab mb-48 overflow-x-auto">
                                    ...
                                    <li class="item-title hover-tooltip" style="display:none !important;">
                                        Colorado
                                        <span class="tooltip">9 Listing</span>
                                    </li>
                                </ul>
                                <div class="widget-content-tab">
                                    <div class="widget-content-inner active">
                                        <div class="swiper sw-layout style-pagination " data-screen-xl="4"
                                            data-preview="3" data-desktop="3" data-tablet="2" data-mobile-sm="1"
                                            data-mobile="1" data-space="15" data-space-md="30" data-space-lg="40"
                                            data-speed="1000">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="content">
                                <div class="heading-section ">
                                    <h2 class="title split-text effect-right">Do you need a home loan? <br>
                                        Get pre-approved</h2>
                                    <p class="text-1 split-text split-lines-transform">Find a lender who can offer
                        ...
                        <div class="col-lg-6">
                            <div class="image-wrap img-animation wow animate__animated">
                                <img class="lazyload parallax-img" data-src="{{ asset('assets/images/section/section-pre-approved.jpg') }}"
                                    src="{{ asset('assets/images/section/section-pre-approved.jpg') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="section-neighborhoods ">
                <div class="tf-container full">
                    <div class="col-12">
                        <div class="heading-section text-center mb-48">
                            <h2 class="title split-text effect-right">Explore The Neighborhoods</h2>
                            <p class="text-1 split-text split-lines-transform">Find your dream apartment with our
                                listing
                            </p>
                        </div>
                        ...
                        <div class="wrap-neighborhoods">
                            <div class="box-location hover-img item-1">
                                <div class="image-wrap">
                                    <a href="#">
                                        <img class="lazyload" data-src="{{ asset('assets/images/newimages/property/Vanguard/g-1-1-1.jpg') }}"
                                            src="{{ asset('assets/images/newimages/property/Vanguard/g-1-1-1.jpg') }}" alt="">
                                    </a>
                                ...
                                <div class="content">
                                    ...
                                    <a href="/franck-muller-vanguard"
                                        class="text-1 tf-btn style-border pd-23 text_white  tf-btn style-border pd-23">View Detailed <i class="icon-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="box-location hover-img item-2">
                                <div class="image-wrap" style="height:100% !important;">
                                    <a href="/kempinski-marina-residences" >
                                        <img class="lazyload" data-src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-9.jpg') }} "
                                            src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-9.jpg') }}" alt="" >
                                    </a>
                                </div>
                                <div class="content">
                                    <h6 class="text_white">Dubai Marina</h6>
                                    <a href="/kempinski-marina-residences" class="text-1 tf-btn style-border pd-23 text_white">View Detailed <i
            ...
            <!-- .section-listing -->
            <section class="section-listing tf-spacing-1" style="display:none !important;">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center mb-48">
                                <h2 class="title split-text effect-right">Open Houses Listings</h2>
                                <p class="text-1 split-text split-lines-transform">Thousands of luxury home enthusiasts
                                    just like you
                                    visit our website.
                                </p>
                                ...
                                <div class="swiper-wrapper tf-layout-mobile-lg lg-col-2 ">
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img style-list ">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1.html">
                                                    <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-list-1.jpg') }}"
                                                        src="{{ asset('assets/images/section/box-house-list-1.jpg') }}  " alt="">
                                                </a>
                                                <ul class="box-tag flex gap-8 ">
                                                    <li class="flat-tag text-4 bg-main fw-6 text_white">For Sale</li>
                                                </ul>
                                                <div class="list-btn flex gap-8 ">
                                                    <a href="#" class="btn-icon save hover-tooltip"><i
                                                            class="icon-save"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img style-list ">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1.html">
                                                    <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-list-2.jpg') }}   "
                                                        src="{{ asset('assets/images/section/box-house-list-2.jpg') }}  " alt="">
                                                </a>
                                                <ul class="box-tag flex gap-8 ">
                                                    <li class="flat-tag text-4 bg-main fw-6 text_white">For Sale</li>
                                                </ul>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img style-list ">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1.html">
                                                    <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-list-3.jpg') }}  "
                                                        src="{{ asset('assets/images/section/box-house-list-3.jpg') }}   " alt="">
                                                </a>
                                                <ul class="box-tag flex gap-8 ">
                                                    <li class="flat-tag text-4 bg-main fw-6 text_white">For Sale</li>
                                                </ul>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img style-list ">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1.html">
                                                    <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-list-4.jpg') }}   "
                                                        src="{{ asset('assets/images/section/box-house-list-4.jpg') }}   " alt="">
                                                </a>
                                                <ul class="box-tag flex gap-8 ">
                                                    <li class="flat-tag text-4 bg-main fw-6 text_white">For Sale</li>
                                                </ul>
            ...
            <!-- /.section-listing -->
             ...
             <div class=" " style="margin-top:50px !important;">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section mb-46 justify-content-between d-flex flex-row mb-55">
                                <div class="left">
                ...
                <div class=" stack-element">
                    <div class="stack-content-wrap">
                        <div class="box-listings style-3 element">
                            <div class="tf-container">
                                <div class="row">
                                                        ...
                                                        <div>
                                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#5C5E61" stroke-width="1.5"
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M14 14L8 8" stroke="#5C5E61" stroke-width="1.5"
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M14 10V14H10" stroke="#5C5E61"
                    ...
                    <div class="tf-container">
                        <div class="row">
                            <div class="col-12 wrap-partners">
                                <div class="heading-section  text-center mb-48">
                                    <h2 class="title split-text effect-right">Let’s Work Together</h2>
                                    <p class="text-1 split-text effect-right">Thousands of luxury home enthusiasts just
                                        like you
                                        visit
                                        our website.
                                    </p>
                                </div>
                                <div class="infiniteslide wrap-partners mb-40" data-clone="2" data-style="left">
                                        ...
                                        <svg width="126" height="82" viewBox="0 0 126 82" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_2304_5655)">
                                                ...
                                                <path
                                                    ...
                                                    fill="#B9B9B9" />
                                                <path d="M44.01 54.7979H46.8V72.0986H44.01V54.7979Z" fill="#B9B9B9" />
                                                <path
                                        ...
                                        <svg width="153" height="30" viewBox="0 0 153 30" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_2304_5818)">
                                                ...
                                                <path
                                                    ...
                                                    fill="#B9B9B9" />
                                                <path d="M140.073 3.84326H144.779V16.5917H153V20.6828H140.073V3.84326Z"
                                                    fill="#B9B9B9" />
                                                <path
                                                ...
                                                <path d="M3.67173 14.6069V29.9328H0V17.916L3.67173 14.6069Z"
                                                    fill="#E7E7E7" />
                                                <path d="M3.67172 14.6069V29.9328H7.34345V17.1718L3.67172 14.6069Z"
                                                    fill="#B9B9B9" />
                                                <path d="M10.9092 8.34619V29.9327H6.01215V12.9166L10.9092 8.34619Z"
                                                    fill="#E7E7E7" />
                                                <path d="M10.9092 8.34619V29.9327H15.802V11.7646L10.9092 8.34619Z"
                                                    fill="#B9B9B9" />
                                ...
                                <div class="infiniteslide wrap-partners" data-clone="2" data-style="right">
                                    <div class="partner-item style-2 ">
                                    ...
                                    <div class="partner-item style-2 ">
                                        <svg width="180" height="100" viewBox="0 0 180 100" fill="none"
                                            ...
                                            <path
                                                ...
                                                fill="#B9B9B9" />
                                            <path d="M99.9418 57.314H99.2817V60.7794H101.702V60.2293H99.9418V57.314Z"
                                                fill="#B9B9B9" />
                                            <path d="M107.367 57.314H106.652V60.7794H107.367V57.314Z" fill="#B9B9B9" />
                                            <path
                                        ...
                                        <svg width="180" height="100" viewBox="0 0 180 100" fill="none"
                                            ...
                                            <g clip-path="url(#clip0_2308_4877)">
                                                <mask id="mask0_2308_4877" style="mask-type:luminance"
                                                    maskUnits="userSpaceOnUse" x="-6" y="-46" width="194" height="193">
                                                    <path d="M187.062 -45.9746H-5.06299V146.151H187.062V-45.9746Z"
                                                        fill="white" />
                                                </mask>
            ...
            <section class="section-opinion ">
                <div class="tf-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center mb-48">
                                <h2 class="title split-text effect-right">Insight & Opinion</h2>
                                <p class="text-1 split-text split-lines-transform">Thousands of luxury home enthusiasts
                                    just like you
                                    visit our website.
                                </p>
                            </div>
                            <div class="swiper style-pagination sw-layout" data-preview="3" data-tablet="2"
                                ...
                                <div class="swiper-wrapper ">
                                    <div class="swiper-slide">
                                        <div class="blog-article-item style-2 hover-img ">
                                            <div class=" image-wrap ">
                                                ...
                                                <div class="box-tag">
                                                    <div class="tag-item text-4 text_white fw-6">Real estate</div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="blog-article-item style-2 hover-img ">
                                            <div class=" image-wrap ">
                                                <a href="blog-details.html">
                                                    <img class="lazyload" data-src="{{ asset('assets/images/blog/blog-grid-2.jpg') }}  "
                                                        src="{{ asset('assets/images/blog/blog-grid-2.jpg') }}  " alt="">
                                                </a>
                                                <div class="box-tag">
                                                    <div class="tag-item text-4 text_white fw-6">News</div>
                                                </div>
                                            </div>
                                            <div class="article-content">
                                                <div class="time">
                                    ...
                                    <div class="swiper-slide ">
                                        <div class="blog-article-item style-2 hover-img">
                                            <div class=" image-wrap ">
                                                <a href="blog-details.html">
                                                    <img class="lazyload" data-src="{{ asset('assets/images/blog/blog-grid-3.jpg') }}  "
                                                        src="{{ asset('assets/images/blog/blog-grid-3.jpg') }}  " alt="">
                                                </a>
                                                <div class="box-tag">
                                                    <div class="tag-item text-4 text_white fw-6">Real estate</div>
                                                </div>
                                ...
                                <div class="sw-pagination sw-pagination-layout text-center d-lg-none d-block mt-20">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-section text-center mb-56 gap-32">
                                ...
                                <p class="text-1 split-text split-lines-transform">We are committed to building
                                    long-term relationships with our
                                    clients based on trust and integrity.
                                </p>
                            </div>
                            <div class="tf-grid-layout md-col-3 wrap">
                                <div class="infiniteslide  " data-clone="1" data-style="up">
                                    <div class="wg-testimonial style-2">
                                        ...
                                        <p class="text-1 description">"My experience with property management
                                            services
                                    ...
                                    <div class="wg-testimonial style-2">
                                        ...
                                        <p class="text-1 description">Quisque tincidunt, nunc vitae maximus
                                            lobortis,
                                            tellus risus fringilla mi, pulvinar feugiat lacus ipsum nec tortor.
                                            Aliquam
                                            a venenatis orci, id bibendum eros.</p>
                                        <div class="author">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/images/avatar/avt-png7.png') }} " alt="">
                                            </div>
                                            <div class="content">
                                                <h6 class="name">
                                    ...
                                    <div class="wg-testimonial style-2">
                                        ...
                                        <p class="text-1 description">Lorem ipsum dolor sit amet, consectetur
                                            ...
                                            venenatis convallis. Nam et ullamcorper nibh. Nulla malesuada
                                            consectetur
                                            sem ut varius. </p>
                                        <div class="author">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/images/avatar/avt-png12.png') }} " alt="">
                                            </div>
                                            <div class="content">
                                                <h6 class="name">
                                ...
                                <div class="infiniteslide " data-clone="1" data-style="down">
                                    <div class="wg-testimonial style-2">
                                        ...
                                        <p class="text-1 description">In hac habitasse platea dictumst. Sed eleifend
                                            aliquam dui quis convallis. Sed aliquet eros sit amet metus rhoncus
                                            bibendum
                                            nec vel nunc. Nullam ac dapibus enim. Nulla rhoncus ante ante, nec
                                            lacinia
                                    ...
                                    <div class="wg-testimonial style-2">
                                        ...
                                        <p class="text-1 description">Aenean orci lorem, pharetra ac imperdiet eget,
                                            tristique ac magna. In aliquet efficitur turpis, et posuere tellus
                                            commodo
                                            at. Morbi accumsan nulla id neque rutrum, et tempus dui venenatis.
                                            Quisque
                                            dapibus metus ligula, id tempor nisl interdum vitae.</p>
                                        <div class="author">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/images/avatar/avt-png6.png') }} " alt="">
                                            </div>
                                            <div class="content">
                                                <h6 class="name">
                                    ...
                                    <div class="wg-testimonial style-2">
                                        ...
                                        <div class="author">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/images/avatar/avt-png5.png') }} " alt="">
                                            </div>
                                            <div class="content">
                                                <h6 class="name">
                                ...
                                <div class="infiniteslide " data-clone="1" data-style="up">
                                    <div class="wg-testimonial style-2">
                                        ...
                                        <p class="text-1 description">Vivamus at nisl ornare, vulputate turpis
                                            finibus,
                                            posuere metus. Donec in placerat felis. Praesent ante tellus, dignissim
                                            nec
                                            imperdiet ac.</p>
                                        <div class="author">
                                            <div class="avatar">
                                                <img src="{{ asset('assets/images/avatar/avt-png8.png') }} " alt="">
                                            </div>
                                            <div class="content">
                                                <h6 class="name">
