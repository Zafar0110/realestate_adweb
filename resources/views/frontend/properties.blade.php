                                    ...
                                    <div class="tab-pane active show" id="gridLayout" role="tabpanel">
                                        <div class="tf-grid-layout lg-col-3 md-col-2">
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    ...
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text_white">Featured
                                                        </li>
                                                ...
                                                <div class="content">
                                                    <h5 class="title">
                                                        <a href="/property-detailed">Elegant studio flat</a>
                                                    ...
                                                    <div class="bot flex justify-between items-center">
                                                        ...
                                                        <div class="wrap-btn flex">
                                                            <a href="#"
                                                                class="compare flex gap-8 items-center text-1"><i
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-7.jpg') }}"
                                                            src="{{ asset('assets/images/section/box-house-7.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text_white">Featured
                                                        </li>
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-8.jpg') }}"
                                                            src="{{ asset('assets/images/section/box-house-2.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text_white">Featured
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-9.jpg') }}"
                                                            src="{{ asset('assets/images/section/box-house-9.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text_white">Featured
                                                        </li>
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-16.jpg') }}"
                                                            src="{{ asset('assets/images/section/box-house-16.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text_white">Featured
                                                        </li>
                                            ...
                                            <div class="box-house hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-17.jpg') }}"
                                                            src="{{ asset('assets/images/section/box-house-17.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text_white">Featured
                                                        </li>
                                        ...
                                        <div class="tf-grid-layout lg-col-2">
                                            ...
                                            <div class="box-house style-list hover-img">
                                                <div class="image-wrap">
                                                    <a href="property-detail-v1.html">
                                                        <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-8.jpg') }}"
                                                            src="{{ asset('assets/images/section/box-house-8.jpg') }}" alt="">
                                                    </a>
                                                    <ul class="box-tag flex gap-8 ">
                                                        <li class="flat-tag text-4 bg-main fw-6 text_white">Featured
                                                        </li>
