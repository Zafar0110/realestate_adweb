                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/section/property-details-v3-1.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/section/property-details-v3-1.jpg') }}"
                                                        src="{{ asset('assets/images/section/property-details-v3-1.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/section/property-details-v3-2.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/section/property-details-v3-2.jpg') }}"
                                                        src="{{ asset('assets/images/section/property-details-v3-2.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/section/property-details-v3-3.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/section/property-details-v3-3.jpg') }}"
                                                        src="{{ asset('assets/images/section/property-details-v3-3.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/section/property-details-v3-4.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/section/property-details-v3-4.jpg') }}"
                                                        src="{{ asset('assets/images/section/property-details-v3-4.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/section/property-details-v3-5.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/section/property-details-v3-5.jpg') }}"
                                                        src="{{ asset('assets/images/section/property-details-v3-5.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/section/property-details-v3-1.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/section/property-details-v3-2.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/section/property-details-v3-3.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/section/property-details-v3-4.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/section/property-details-v3-5.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class=" wg-property video spacing-2">
                                ...
                                <div class="widget-video style-1">
                                    <img class="lazyload" data-src="{{ asset('assets/images/section/property-detail.jpg') }}"
                                        src="{{ asset('assets/images/section/property-detail.jpg') }}" alt="">
                                ...
                                <ul class="box-floor" id="parent-floor">
                                    <li class="floor-item">
                                        ...
                                        <div id="floor-one" class="collapse show" data-bs-parent="#parent-floor">
                                            <div class="faq-body">
                                                <div class="box-img">
                                                    <img src="{{ asset('assets/images/section/floor.jpg') }}  " alt="img-floor">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="wg-property box-attachments spacing-5">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="#" target="_blank" class="attachments-item">
                                            <div class="box-icon w-60">
                                                <img src="{{ asset('assets/images/items/download-1.png') }}  " alt="file">
                                            </div>
                                    ...
                                    <div class="col-sm-6">
                                        <a href="#" target="_blank" class="attachments-item">
                                            <div class="box-icon w-60">
                                                <img src="{{ asset('assets/images/items/download-2.png') }}" alt="file">
                                            </div>
                                            <span>Villa-Document.pdf</span>
                                            <i class="icon icon-DownloadSimple"></i>
                                        </a>
                            ...
                            <div class="wg-property box-virtual-tour spacing-6">
                                ...
                                <div class="image-wrap">
                                    <img src="{{ asset('assets/images/section/property-detail-2.jpg') }}  " alt="">
                                    <div class="box-icon">
                                        <div class="icons">
                                            <i class="icon-360"></i>
                                        </div>
                            ...
                            <div class="wg-property mb-0 box-comment spacing-8">
                                <div class="wrap-comment">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="comment">
                                                        ...
                                                        <div class="group-image">
                                                            ...
                                                            <img src="{{ asset('assets/images/blog/comment-3.jpg') }}" alt="">
                                                        </div>
                                                        <div class="action action-button-list">
                                    ...
                                    <a href="#" class="tf-btn style-border fw-7 pd-1">
                                        <span>View all reivew </span>
                                        <i class="icon-arrow-right-2 fw-4"></i>
                                    </a>
                                </div>
                                <div class="box-send ">
                                ...
                                <div class="swiper-wrapper tf-layout-mobile-xl  lg-col-3 wrap-agent wow fadeInUp"
                                        ...
                                        <div class="box-house hover-img">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1.html">
                                                    <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-21.jpg') }}"
                                                        src="{{ asset('assets/images/section/box-house-21.jpg') }}   " alt="">
                                                </a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1.html">
                                                    <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-18.jpg') }}"
                                                        src="{{ asset('assets/images/section/box-house-18.jpg') }}" alt="">
                                                </a>
                                                <ul class="box-tag flex gap-8 ">
                                                    <li class="flat-tag text-4 bg-main fw-6 text_white">Featured</li>
                                                    <li class="flat-tag text-4 bg-3 fw-6 text_white">For Sale</li>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-house hover-img">
                                            <div class="image-wrap">
                                                <a href="property-detail-v1.html">
                                                    <img class="lazyload" data-src="{{ asset('assets/images/section/box-house-15.jpg') }}"
                                                        src="{{ asset('assets/images/section/box-house-15.jpg') }}" alt="">
                                                </a>
                                                <ul class="box-tag flex gap-8 ">
                                                    <li class="flat-tag text-4 bg-main fw-6 text_white">Featured</li>
                                                    <li class="flat-tag text-4 bg-3 fw-6 text_white">For Sale</li>
