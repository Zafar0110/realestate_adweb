...
<!-- Mirrored from themesflat.co/html/proty/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 06:05:37 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8" />
    <!--[if IE ]><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/><![endif]-->
    <title>{{ $seo['title'] ?? 'RealFun' }}
    Real Estate </title>
...
<body class="popup-loader">
    ...
    <div id="wrapper">
        ...
        <div class="popup-setting">
            <div class="btn-setting"><a href="javascript:void(0)" class="sw-click"><i class="icon-settings"></i></a>
            </div>
            <div class="popup-setting-container">
                <div class="btn-RTL mb-20">
                    <span class="title text-1 fw-5 text-color-heading mb-8">RTL: </span>
                    <a href="javascript:void(0);" id="toggle-rtl" class="btn-style-2 radius-3">rtl</a>
                </div>
                <div class="toggle-container">
                    <span class="title text-1 fw-5 text-color-heading mb-8">Theme Mode: </span>
        ...
        @if (!request()->is('property-detailed'))
        <!-- .preload -->
        <div id="loading">
            <div id="loading-center">
                <div class="loader-container">
                    <div class="wrap-loader">
                        ...
                        <div class="icon">
                            <img src="{{asset('assets/images/logo/loading.png') }}" alt="logo_icon">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <li class="menu-item menu-item-has-children-mobile current-menu-item">
                        ...
                        <div id="dropdown-menu-one" class="collapse" data-bs-parent="#menu-mobile-menu">
                            <ul class="sub-mobile ">
                                ...
                                <li class="menu-item"><a href="home05.html">Home Page 05</a></li>
                                <li class="menu-item"><a href="home06.html">Home Page 06</a></li>
                                <li class="menu-item"><a href="home07.html">Home Page 07</a></li>
                                <li class="menu-item"><a href="home08.html">Home Page 08</a></li>
                                <li class="menu-item"><a href="home09.html">Home Page 09</a></li>
                                <li class="menu-item"><a href="home10.html">Home Page 10</a></li>
                            </ul>
                        </div>
                    </li>
    ...
    <script src="{{ asset('assets/forms/end-form/build/main.js') }}"></script>
...
<!-- Mirrored from themesflat.co/html/proty/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2026 06:07:15 GMT -->
</html>