                    ...
                    <div class="col-lg-12">
                        <div class="title-inner ">
                            <ul class="breadcrumb">
                                ...
                                <li>Property AquaCrest Residences</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-6.jpg') }}"
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-2.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-2.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-2.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-3.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-3.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-3.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-4.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-4.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-4.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-7.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-7.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-7.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-8.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-8.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-8.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-6.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-2.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-3.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-4.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-7.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/AquaCrest/Aquacrest-g-8.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">5543</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Sobha AquaCrest by Sobha Realty is a luxury residential development that reimagines coastal living within the Downtown Umm Al Quwain area. Spanning five architecturally distinct towers, the project embodies the developer’s signature craftsmanship, backward integration model, and attention to design detail. Each tower offers a curated selection of 1 to 3-bedroom apartments.
                                        <br>Beyond architecture, Sobha AquaCrest is built on a philosophy of wellness, sustainability, and timeless design. Residents enjoy access to an array of wellness facilities, landscaped courtyards, and beachfront promenades that seamlessly blend urban energy with nature’s calm. The project represents a rare convergence of design excellence, environmental consciousness, and long-term value, positioning it as one of the most significant residential investments in the UAE’s northern emirates.
                            ...
                            <div class="wg-property box-amenities spacing-3">
                                ...
                                <p>AquaCrest Residences offers an exceptional array of world-class amenities designed to enhance every aspect of modern living.
                                </p>
                                <br>
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Sobha AquaCrest location at Downtown Umm Al Quwain offers a prime waterfront setting along the Arabian Sea. The neighborhood is close to major attractions including the UAQ New Corniche and the Ed-Dur Archaeological Site. Its location near the main highway connects the community to Ajman and Sharjah, making it both a serene coastal retreat and a strategically connected residential address.
                                    </p>    
                            </div>
