                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/avarra/Gallery-1-27.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/avarra/Gallery-1-27.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/avarra/Gallery-1-27.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/avarra/Gallery-3-27.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/avarra/Gallery-3-27.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/avarra/Gallery-3-27.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/avarra/Gallery-4-26.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/avarra/Gallery-5-24.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/avarra/Gallery-5-24.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/avarra/Gallery-5-24.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/avarra/Gallery-6-23.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/avarra/Gallery-6-23.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/avarra/Gallery-6-23.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/avarra/Gallery-7-23.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/avarra/Gallery-7-23.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/avarra/Gallery-7-23.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/avarra/Gallery-1-27.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/avarra/Gallery-3-27.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/avarra/Gallery-4-26.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/avarra/Gallery-5-24.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/avarra/Gallery-6-23.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/avarra/Gallery-7-23.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">22112</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Avarra by Palace at Business Bay introduces a refined residential experience shaped by the Palace Hotels + Resorts brand, offering 687 units across 1, 2, 3, and 4-bedroom apartments. The development blends contemporary architecture with warm tones, premium materials, and expansive glass that frames city and sea views, including the iconic Burj Khalifa .
 
                                    </p>
                                    <p class="description text-1 mb-10">Avarra by Palace by Emaar Properties elevates everyday living through curated amenities such as an infinity pool and pool deck, gym and outdoor fitness areas, kids’ play zones, and peaceful wellness spaces. With a 10% down payment and strong high ROI potential, the project appeals to residents and investors seeking long-term value in a prime urban location .
                                    </p>
                            ...
                            <div class="wg-property box-amenities spacing-3">
                                ...
                                <p>Avarra offers an exceptional array of world-class amenities designed to enhance every aspect of modern living.
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Avarra by Palace by Emaar Properties is located in Business Bay, offering a strategic position near Sheikh Zayed Road (E11) and minutes from Dubai’s most prominent destinations. The setting provides a balance of cosmopolitan energy, waterfront surroundings, and direct access to Downtown Dubai, making it ideal for residents seeking convenience, lifestyle appeal, and exceptional connectivity.
                                    </p>    
                            </div>
