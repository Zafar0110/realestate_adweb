                    ...
                    <div class="col-lg-12">
                        <div class="title-inner ">
                            <ul class="breadcrumb">
                                ...
                                <li>Property Binghatti Aquarise</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-3.jpg') }}"
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-1.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-1.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-1.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-2.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-2.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-2.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-4.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-4.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-4.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-5.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-5.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-5.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-6.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-6.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-6.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-3.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-1.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-2.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-4.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-5.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Binghatti/Aquarise-g-6.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="info flex justify-between">
                                    <div class="feature">
                                        ...
                                        <ul class="meta-list flex">
                                            <li class="text-1 flex"><span>1, 2, 3, 4, Studio</span>Bed</li>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">6342</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">Apartments,  <br> Retail Units,</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">1, 2, 3, 4, Studio</div>
                                            </div>
                                        </div>
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Binghatti Aquarise at Business Bay stands as a striking addition to Dubai’s skyline, uniting bold architectural form with refined, high-end finishes. This distinguished tower presents a meticulously designed selection of studios to 4-bedroom apartments, alongside premium retail spaces. Select residences feature private pools, offering an elevated standard of luxury living tailored for the discerning resident.


                                        <br>Residents will enjoy an array of exclusive amenities, including a 27,000 sq ft private beach, a 44-meter sky infinity pool, 16 curated restaurants and retail outlets, and the state-of-the-art Oval Signature Gym. With its sophisticated lifestyle offerings and iconic design, Binghatti Aquarise redefines premium urban living in Business Bay.
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Business Bay is one of Dubai’s most prestigious and strategically located districts, offering seamless connectivity to Downtown Dubai, DIFC, and Sheikh Zayed Road. Known for its dynamic blend of corporate offices, luxury residences, and world-class dining and retail, it continues to be a magnet for professionals, investors, and lifestyle seekers alike.


                                    </p>
                                    <p>The Binghatti Aquarise Location places residents in the heart of this thriving urban hub. With waterfront views, vibrant surroundings, and direct access to the city’s most iconic landmarks, Business Bay delivers both convenience and prestige—making it the ideal setting for high-end urban living.
