                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Canal/Gallery-1-22.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Canal/Gallery-1-22.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Canal/Gallery-1-22.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Canal/Gallery-2-22.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Canal/Gallery-2-22.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Canal/Gallery-2-22.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Canal/Gallery-3-21.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Canal/Gallery-3-21.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Canal/Gallery-3-21.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Canal/Gallery-4-21.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Canal/Gallery-4-21.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Canal/Gallery-4-21.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Canal/Gallery-5-21.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Canal/Gallery-5-21.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Canal/Gallery-5-21.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Canal/Gallery-8-20.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Canal/Gallery-1-22.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Canal/Gallery-2-22.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Canal/Gallery-3-21.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Canal/Gallery-4-21.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Canal/Gallery-5-21.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Canal/Gallery-8-20.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">6632</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Wedyan by Al Ghurair Development is a prestigious waterfront development located along the Dubai Water Canal in Business Bay. The first project under the Al Ghurair Collection, it features architecture by the renowned Kengo Kuma, blending organic design with luxurious living. Offering 149 units across 40 floors, the development includes 3, 4, and 5-bedroom apartments, penthouses, and a sky villa, all designed for high capital appreciation. The project offers a 10% down payment to facilitate investment.
                                ...
                                <div class="box">
                                    <ul>
                                        ...
                                        <li class="flex">
                                            ...
                                            <p>Apartments, Penthouses, Sky Villa</p>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li class="flex">
                                            <p class="fw-6">Developer</p>
                                            <p>Al Ghurair Development</p>
                                        </li>
                                        <li class="flex">
                            ...
                            <div class="wg-property box-amenities spacing-3">
                                ...
                                <p>The Canal offers an exceptional array of world-class amenities designed to enhance every aspect of modern living.
                                ...
                                <div class="wrap-feature">
                                    <div class="box-feature">
                                        <ul>
                                            ...
                                            Outdoor Lagoon Pool & Canal Lap Pool
                                            </li>
                                            <li class="feature-item">
                                            Cardio and Strength Training Gym
                                            </li>
                                            <li class="feature-item">
                                            Pilates & Yoga Sanctuary
                                            </li>
                                            <li class="feature-item">
                                            Kids’ Club & Children’s Splash Pool
                                            </li>
                                            <li class="feature-item">
                                            ...
                                            <li class="feature-item">
                                            Gradual Immersion Pool & Open-Air Bathing Pools
                                ...
                                <ul class="box-floor" id="parent-floor">
                                    <li class="floor-item">
                                        ...
                                        <div id="floor-one" class="collapse show" data-bs-parent="#parent-floor">
                                            <div class="faq-body">
                                                <div class="box-img">
                                                    <img src="{{ asset('assets/images/newimages/property/Canal/Floorplan-2-BHK.jpg') }}  " alt="img-floor">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="floor-item">
                                        ...
                                        <div id="floor-two" class="collapse" data-bs-parent="#parent-floor">
                                            <div class="faq-body">
                                                <div class="box-img">
                                                    <img src="{{ asset('assets/images/newimages/property/Canal/Floorplan-1-BHK.jpg') }} " alt="img-floor">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Wedyan Al Ghurair Collection is strategically located in Business Bay, offering both city energy and waterfront serenity. Residents are connected to Dubai’s most iconic destinations, with easy access to Sheikh Zayed Road (E11).
