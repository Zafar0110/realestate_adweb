                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/ELA/ela-residences-1.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/ELA/ela-residences-1.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/ELA/ela-residences-1.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/ELA/ela-residences-2.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/ELA/ela-residences-3.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/ELA/ela-residences-3.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/ELA/ela-residences-3.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/ELA/ela-residences-4.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/ELA/ela-residences-4.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/ELA/ela-residences-4.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/ELA/ela-residences-5.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/ELA/ela-residences-5.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/ELA/ela-residences-5.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/ELA/ela-residences-6.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/ELA/ela-residences-6.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/ELA/ela-residences-6.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/ELA/ela-residences-1.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/ELA/ela-residences-2.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/ELA/ela-residences-3.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/ELA/ela-residences-4.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/ELA/ela-residences-5.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/ELA/ela-residences-6.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="info flex justify-between">
                                    <div class="feature">
                                        ...
                                        <ul class="meta-list flex">
                                            <li class="text-1 flex"><span>3, 4</span>Bed</li>
                                            <li class="text-1 flex"><span>3, 4</span>Bath</li>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">3376</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading"> 3, 4 </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wrap-box">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Omniyat’s architectural masterpiece, ELA Residences, is the final residential destination to be built in Palm Jumeriah. It features premium 3- and 4-bedroom simplex, duplex apartments, and three magnificent super penthouses. From their apartments, residents can enjoy breathtaking views of the Arabian Gulf, Burj Al Arab, and Burj Khalifa. Highly acclaimed designer Vladimir Djurovic designed the exclusive residential enclave. Designed by architect Zaha Hadid, Ela Residences offers its discerning residents the Dorchester Collection’s suite-like services. These include branded spas, private pools, and sun lounging spaces.

                                    sits a public plaza animated by interactive water features, an amphitheatre, pocket gardens, and landscaped walkways. A dedicated Level 6 amenity deck adds lap and family pools, kids’ pools, male and female gyms, yoga zones, a teen recreation centre, and majlis seating, giving residents two distinct lifestyle layers within the same address.
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Celebrated Designs: Be inspired by the works of landscape architect Vladimir Djurovic and architect Zaha Hadid, whose visionary creations define this exceptional residence., Luxurious Amenities: Enjoy a 5-star lifestyle with exclusive perks like valet parking, in-residence catering, and housekeeping services., Spectacular Views: Take in breathtaking vistas of the Arabian Gulf, Burj Al Arab, and Burj Khalifa from the comfort of your home., Flexible Payment Plans: Start your journey with a convenient payment plan, requiring just a 5 percent downpayment., Diverse Layouts: Choose from an array of floor plans from simplex units to super penthouses.
                            ...
                            <div class="wg-property box-amenities spacing-3">
                                ...
                                <p>Raw District 2 offers an exceptional array of world-class amenities designed to enhance every aspect of modern living.
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Experience the tranquillity of Ela Residences’ secluded beachfront, which extends over 250 meters along the Eastern Crescent of Palm Jumeirah. Positioned as the ultimate landmark in Palm Jumeirah, Ela Residences occupies a prestigious location, one of the few remaining exclusive spots on this renowned global icon.
