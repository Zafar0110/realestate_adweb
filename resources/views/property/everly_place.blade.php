                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Everly/Gallery-1-6.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Everly/Gallery-1-6.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Everly/Gallery-1-6.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Everly/Gallery-2-6.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Everly/Gallery-2-6.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Everly/Gallery-2-6.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Everly/Gallery-3-5.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Everly/Gallery-3-5.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Everly/Gallery-3-5.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Everly/Gallery-4-5.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Everly/Gallery-4-5.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Everly/Gallery-4-5.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Everly/Gallery-5-4.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Everly/Gallery-5-4.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Everly/Gallery-5-4.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Everly/Gallery-6-4.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Everly/Gallery-6-4.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Everly/Gallery-6-4.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Everly/Gallery-1-6.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Everly/Gallery-2-6.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Everly/Gallery-3-5.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Everly/Gallery-4-5.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Everly/Gallery-5-4.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Everly/Gallery-6-4.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">4312</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Everly Place at MBR City is an off-plan residential development by Ellington Properties, offering 209 units across 13 floors. The project <strong>features 1, 2, and 3-bedroom apartments designed around light, space</strong>, and lagoon-facing views, creating an address with strong potential for capital appreciation.
                                        <br>Everly Place by Ellington Properties brings a calm waterfront lifestyle to Mohammed Bin Rashid City with carefully planned homes and lifestyle amenities. Residents can enjoy a resort-style swimming pool, outdoor cinema, fitness studio, and club lounge, all shaped around comfort, wellness, and social connection.
                                    </p>
                            ...
                            <div class="wg-property box-amenities spacing-3">
                                ...
                                <p>Everly Place offers an exceptional array of world-class amenities designed to enhance every aspect of modern living.</p>
                                <br>
                                <div class="wrap-feature">
                                    <div class="box-feature">
                                        <ul>
                                            ...
                                            <li class="feature-item">
                                            Club Lounge Overlooking The Crystal Lagoon
                                            </li>
                                            <li class="feature-item">
                                            ...
                                            <li class="feature-item">
                                            Sauna & Chromatherapy Shower Experience
                                            </li>
                                            <li class="feature-item">
                                            Resort-Style Swimming Pool & Shaded Kids’ Pool
                                            </li>
                                            <li class="feature-item">
                                            Sun Loungers, Sunken Seating & Cabanas
                                            </li>
                                            <li class="feature-item">
                                            Outdoor BBQ Area & Shaded Seating
                                            </li>
                                            <li class="feature-item">
                                            Outdoor Cinema
                                            </li>
                                            <li class="feature-item">
                                            Bowling Alleys & Outdoor Table Tennis
                                            </li>
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Ellington Everly Place is located in Mohammed Bin Rashid City, one of Dubai’s most well-connected and fast-growing residential destinations. Positioned close to Al Khail Road (E44), the project offers smooth access to key business districts, lifestyle attractions, retail hubs, and leisure destinations across the city.
                                        </p>    
                            </div>
