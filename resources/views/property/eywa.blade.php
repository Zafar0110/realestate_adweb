                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Eywa/Gallery-2-9.jpg') }}"
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Eywa/Gallery-3-10.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Eywa/Gallery-3-10.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Eywa/Gallery-3-10.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Eywa/Gallery-4-10.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Eywa/Gallery-4-10.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Eywa/Gallery-4-10.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Eywa/Gallery-5-8.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Eywa/Gallery-5-8.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Eywa/Gallery-5-8.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Eywa/Gallery-7-7.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Eywa/Gallery-7-7.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Eywa/Gallery-7-7.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Eywa/Gallery-6-7.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Eywa/Gallery-6-7.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Eywa/Gallery-6-7.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Eywa/Gallery-2-9.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Eywa/Gallery-3-10.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Eywa/Gallery-4-10.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Eywa/Gallery-5-8.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Eywa/Gallery-7-7.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Eywa/Gallery-6-7.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">55661</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">Apartments, <br> Duplex
                                                </div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Eywa Way of Water in Business Bay is an ultra-luxury wellness residence designed by architect and interior designer Zane Tetere-Sulce. Overlooking the Dubai Water Canal, the project features only 65 exclusive homes, including 2, 3, and 4-bedroom apartments, 3, 4, and 5-bedroom duplexes, and a signature penthouse, all thoughtfully crafted to embody harmony, sophistication, and wellness.
                                    </p>
                                    <p class="description text-1 mb-10">Each home is crafted for comfort and balance, featuring marble finishes, private terraces, and panoramic views. Residents enjoy exceptional amenities such as six pools, a fitness centre by Nohrd, meditation and crystal labyrinth, and an outdoor cinema with waterfall. With its prestigious location, strong ROI potential, and a 10% down payment, Eywa 2 by R.Evolution is a refined choice for investors and end-users.
                            ...
                            <div class="wg-property box-amenities spacing-3">
                                ...
                                <p>Eywa 2 offers an exceptional array of world-class amenities designed to enhance every aspect of modern living.
                                ...
                                <div class="wrap-feature">
                                    <div class="box-feature">
                                        <ul>
                                            ...
                                            Six Pools (Including Infinity & Indoor Wellness Pool)

                                            </li>
                                            <li class="feature-item">
                                            State-of-the-Art Fitness Centre by Nohrd
                                            </li>
                                            <li class="feature-item">
                                            Steam Room & Sauna
                                            </li>
                                            <li class="feature-item">
                                            Meditation & Crystal Labyrinth
                                            </li>
                                            <li class="feature-item">
                                            Outdoor Cinema with Waterfall
                                            </li>
                                            <li class="feature-item">
                                            Japanese Bath & Ayurvedic Treatment Rooms
                                            </li>
                                            <li class="feature-item">
                                            Sound Healing Pyramid
                                            </li>
                                            <li class="feature-item">
                                            Health Bar & Tea House
                                            </li>
                                            <li class="feature-item">
                                            Floating Fireplace & Dining Island
                                            </li>
                                            <li class="feature-item">
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Eywa 2 in Business Bay enjoys a prestigious position along Sheikh Zayed Road (E11), placing residents within moments of Dubai’s most iconic destinations. Its central address offers effortless connectivity to major highways, business districts, and luxury retail and leisure destinations across the city.
