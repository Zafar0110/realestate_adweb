                    ...
                    <div class="col-lg-12">
                        <div class="title-inner ">
                            <ul class="breadcrumb">
                                ...
                                <li>Property Hudayriyat Golf Estates</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-3-8.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-3-8.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-3-8.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-1-9.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-1-9.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-1-9.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-2-9.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-2-9.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-2-9.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-4-8.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-4-8.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-4-8.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-5-7.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-5-7.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-5-7.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-6-7.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-6-7.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-6-7.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-3-8.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-1-9.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-2-9.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-4-8.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-5-7.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Hudayriyat/gallery-6-7.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="info flex justify-between">
                                    <div class="feature">
                                        ...
                                        <ul class="meta-list flex">
                                            <li class="text-1 flex"><span>3, 4, 5, 6</span>Bed</li>
                                            <li class="text-1 flex"><span>3, 4, 5, 6</span>Bath</li>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">3312</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">3, 4, 5, 6 </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">Fairway Villas,  <br> Golf Homes,</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Hudayriyat Golf Estates by Modon Properties is a premium residential community on Al Hudayriat Island, Abu Dhabi, featuring an exclusive collection of 3 to 6-bedroom townhomes, villas, and mansions. Designed around sweeping fairways and waterfront surroundings, the development combines Andalusian-inspired architecture with expansive green landscapes and refined family living.
                                        <br>Hudayriyat Golf Estates on Al Hudayriat Island offers strong potential for high capital appreciation with a flexible 5% initial payment structure. Residents will enjoy access to an 18-hole golf course, country clubhouse, wellness centre, dining and retail outlets, coworking spaces, cycling trails, parks, and a private school within a connected lifestyle-focused master community.
                                ...
                                <div class="box">
                                    <ul>
                                        ...
                                        <li class="flex">
                                            ...
                                            <p>Fairway Villas, Golf Homes, Golf Mansions, Range Villas, Townhomes</p>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li class="flex">
                                            <p class="fw-6">Developer</p>
                                            <p>Modon Properties</p>
                                        </li>
                                        <li class="flex">
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Hudayriyat Golf Estates location places residents on Al Hudayriat Island, Abu Dhabi, offering excellent connectivity through Shakhbout Bin Sultan Street and Hudayriyat Bridge. The community also benefits from convenient access to Sheikh Zayed Bin Sultan Road (E10), allowing smooth travel across key districts, business hubs, lifestyle destinations, and major landmarks throughout the capital.</p>    
                            </div>
