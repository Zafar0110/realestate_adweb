                    ...
                    <div class="col-lg-12">
                        <div class="title-inner ">
                            <ul class="breadcrumb">
                                ...
                                <li>Property Kempinski Marina Residences</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Kempinski/kempinski-9.jpg') }}"
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Kempinski/kempinski-6.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-6.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-6.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Kempinski/kempinski-8.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-8.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-8.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Kempinski/kempinski-5.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-5.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-5.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Kempinski/kempinski-4.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-4.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-4.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Kempinski/kempinski-3.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-3.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Raw District/kempinski-3.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-9.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-6.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-8.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-5.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-4.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Kempinski/kempinski-3.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">33311</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Welcome to Kempinski Residences Dubai Marina, a prestigious new landmark in one of Dubai’s most coveted locations. Discover the epitome of luxury at Kempinski Marina Residences Dubai, a new beacon of sophistication in Dubai Marina. Offering 1 and 2-bedroom apartments, along with 2, 3, 4, and 5-bedroom duplexes, this development blends a prestigious address with Kempinski’s heritage. Indulge in opulent interiors, world-class amenities, and exceptional services. Situated on one of the last prime plots in Dubai Marina, Kempinski Residences Dubai Marina guarantees an unmatched luxury living experience. Managed by Kempinski, a hallmark of excellence since 1897, the residences boast stunning marina and city views, exquisite interiors, and top-notch amenities. Enjoy bespoke services and luxurious comfort, making Kempinski Residences Dubai Marina the premier address for sophisticated living. Inquire today about Kempinski Residences Dubai Marina prices and availability.
                            ...
                            <div class="wg-property box-amenities spacing-3">
                                ...
                                <p>Kempinski Marina Residences offers an exceptional array of world-class amenities designed to enhance every aspect of modern living.
                                ...
                                <div class="wrap-feature">
                                    <div class="box-feature">
                                        <ul>
                                            ...
                                            <li class="feature-item">
                                            Outdoor Kids Play Area & Splash Pool
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Situated mere moments from a vibrant mall, the renowned Kempinski Residences Dubai Marina offers luxurious living with easy access to a variety of eateries, sun-drenched beaches, and convenient city travel. Adjacent to Kempinski Residences Marina, Dubai Marina Mall, and The Walk at Jumeirah Beach Residence are easily accessible, featuring upscale shopping, exquisite dining, and lively nightlife, not to mention the tranquil beaches of the Arabian Gulf.
                                    The Walk JBR 10 mins, Dubai Harbour 10 mins, Dubai Marina 12 mins, Palm Jumeirah 15 mins, Burj Al Arab 20 mins, Bluewater Island 20 mins, Dubai Mall 25 mins
