                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Linar/Gallery-2-10.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Linar/Gallery-2-10.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Linar/Gallery-2-10.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Linar/Gallery-3-9.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Linar/Gallery-3-9.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Linar/Gallery-3-9.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Linar/Gallery-4-9.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Linar/Gallery-4-9.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Linar/Gallery-4-9.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Linar/Gallery-5-8.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Linar/Gallery-5-8.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Linar/Gallery-5-8.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Linar/Gallery-6-8.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Linar/Gallery-6-8.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Linar/Gallery-6-8.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Linar/Gallery-7-4.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Linar/Gallery-7-4.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Raw District/Gallery-7-4.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Linar/Gallery-2-10.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Linar/Gallery-3-9.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Linar/Gallery-4-9.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Linar/Gallery-5-8.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Linar/Gallery-6-8.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Linar/Gallery-7-4.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="info flex justify-between">
                                    <div class="feature">
                                        <p class="location text-1 flex items-center gap-10">
                                            <i class="icon-location"></i>Alef Group
                                        </p>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">12342</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Linar by Alef is a waterfront development featuring 5 residential towers and a future commercial tower, set across 5.5 hectares on the east edge of Mamzar Beach. The project is the latest addition to Alef Group’s portfolio of master-planned Sharjah destinations, designed to bring coastal living, integrated retail, and urban convenience into one address.
                                        <br>At the centre of the community sits a public plaza animated by interactive water features, an amphitheatre, pocket gardens, and landscaped walkways. A dedicated Level 6 amenity deck adds lap and family pools, kids’ pools, male and female gyms, yoga zones, a teen recreation centre, and majlis seating, giving residents two distinct lifestyle layers within the same address.
                                ...
                                <div class="wrap-feature">
                                    <div class="box-feature">
                                        <ul>
                                            ...
                                            <li class="feature-item">
                                                Half Basketball Court & Padel Court
                                            </li>
                                            <li class="feature-item">
                                            Sculpture Garden & Yoga Lawn

                                            </li>
                                            <li class="feature-item">
                                            Outdoor Co-Working Area & Outdoor Meeting Pavilions

                                            </li>
                                            <li class="feature-item">
                                            Labyrinth Garden and Family Lounge

                                            </li>
                                            <li class="feature-item">
                                            Family Pool & Pool Bar
                                            </li>
                                            <li class="feature-item">
                                            Floating Pavilion & Pool Terrace
                                            </li>
                                            <li class="feature-item">
                                            Shallow Pool, Lounge & Terrace
                                            </li>
                                            <li class="feature-item">
                                            Outdoor Cinema Lawn with Movable Bean Bags
                                            </li>
                                            <li class="feature-item">
                                            Hydrotherapy Pool Seating
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <ul class="box-floor" id="parent-floor">
                                    <li class="floor-item">
                                        ...
                                        <div id="floor-one" class="collapse show" data-bs-parent="#parent-floor">
                                            <div class="faq-body">
                                                <div class="box-img">
                                                    <img src="{{ asset('assets/images/newimages/property/Linar/Floorplan-1-Bedroom.jpg') }}  " alt="img-floor">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="floor-item">
                                        ...
                                        <div id="floor-two" class="collapse" data-bs-parent="#parent-floor">
                                            <div class="faq-body">
                                                <div class="box-img">
                                                    <img src="{{ asset('assets/images/newimages/property/Linar/Floorplan-2-Bedroom.jpg') }} " alt="img-floor">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Linar by Alef enjoys a rare coastal position on the east edge of Al Mamzar beach, placing residents directly on the waterfront while keeping them within easy reach of both Sharjah and Dubai. The community sits along Corniche and Al Taawun Street, with direct access to Al Wuheida Road and Al Ittihad Road, the city’s two main connectors into
                                    </p>    
                            </div>
