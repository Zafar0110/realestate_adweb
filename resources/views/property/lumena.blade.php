                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Lumena/alta-g-3.jpg') }}"
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Lumena/alta-g-5.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Lumena/alta-g-5.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Lumena/alta-g-5.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Lumena/alta-g-6.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Lumena/alta-g-6.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Lumena/alta-g-6.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Lumena/alta-g-7.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Lumena/alta-g-7.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Lumena/alta-g-7.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Lumena/alta-g-8.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Lumena/alta-g-8.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Lumena/alta-g-8.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Lumena/alta-g-1.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Lumena/alta-g-1.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Lumena/alta-g-1.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Lumena/alta-g-3.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Lumena/alta-g-5.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Lumena/alta-g-6.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Lumena/alta-g-7.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Lumena/alta-g-8.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Lumena/alta-g-1.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="info flex justify-between">
                                    <div class="feature">
                                        ...
                                        <ul class="meta-list flex">
                                            <li class="text-1 flex"><span>Office</span>Bed</li>
                                            <li class="text-1 flex"><span>1 </span>Bath</li>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">7764</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">Office,  <br> Retail Units,</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">LiPoised at the heart of Dubai’s commercial core, Lumena Alta at Business Bay is a 380-metre-tall mixed-use masterpiece by Omniyat. Blending modern office environments with a world-class hospitality experience, it embodies the brand’s hallmark of architectural artistry and design innovation. The tower’s sculptural form and radiant façade reflect the ascent of a new business icon, one that connects ambition with elegance.


                                    </p>
                                    <p class="description text-1 mb-10">Within this skyline-defining structure, investors will find 45 levels of meticulously designed offices, leisure zones, and a five-star sky hotel that reimagines luxury and performance. Lumena Alta Dubai stands as both a business hub and an investment opportunity, an address crafted for those who lead with vision and seek long-term value in Dubai’s thriving commercial landscape.
                            ...
                            <div class="wg-property box-amenities spacing-3">
                                ...
                                <p>Lumena Alta offers an exceptional array of world-class amenities designed to enhance every aspect of modern living.
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Lumena Alta by Omniyat is located in Business Bay, Dubai’s foremost business and cultural district. Surrounded by the Burj Khalifa, Dubai Canal, and DIFC, this landmark location offers direct links to Sheikh Zayed Road and the Metro network. From this address, the entire city – from Downtown Dubai to Dubai Marina and the airport – remains within minutes.
