                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Mansio/mansio-2.jpg') }}"
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Mansio/mansio-3.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Mansio/mansio-3.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Mansio/mansio-3.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Mansio/mansio-4.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Mansio/mansio-4.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Mansio/mansio-4.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Mansio/mansio-6.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Mansio/mansio-6.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Mansio/mansio-6.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Mansio/mansio-7.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Mansio/mansio-7.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Mansio/mansio-7.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Mansio/mansio-8.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Mansio/mansio-8.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Mansio/mansio-8.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Mansio/mansio-2.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Mansio/mansio-3.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Mansio/mansio-4.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Mansio/mansio-6.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Mansio/mansio-7.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Mansio/mansio-8.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="info flex justify-between">
                                    <div class="feature">
                                        ...
                                        <ul class="meta-list flex">
                                            <li class="text-1 flex"><span>1, 2, 3</span>Bed</li>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">9832</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Immerse yourself in the luxury of Mansio at Th8, a prestigious residential project at Palm Jumeirah, conceptualized by IFA Hotels & Resorts. This high-end development features a range of residential options, including Mansio serviced apartments in 1, 2, and 3-bedroom configurations, exclusive penthouses, and refined townhouses. Each residence is fully furnished and serviced, epitomizing the ideal blend of luxury and convenience, perfect for a lavish second home or a remarkable pied-à-terre for global investors. Mansio at Th8 Palm Jumeirah embodies the essence of the chic, ultra-luxe lifestyle reminiscent of Miami’s South Beach. It offers residents and guests an unmatched living experience, situated on a pristine beachfront. The property boasts state-of-the-art amenities and facilities, and its position on the West Crescent affords residents breathtaking views of the Arabian Gulf and prominent Dubai attractions, including the Dubai Marina skyline, The Atlantis, The Burj Al Arab, and Ain Dubai.
                                ...
                                <div class="box">
                                    <ul>
                                        ...
                                        <li class="flex">
                                            ...
                                            <p>Apartments, Penthouses, Townhouses</p>
                                        </li>
                                    </ul>
                                    <ul>
                                        <li class="flex">
                            ...
                            <div class="wg-property box-amenities spacing-3">
                                ...
                                <p>Mansio at Th8 offers an exceptional array of world-class amenities designed to enhance every aspect of modern living.
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Renowned as the globe’s most illustrious island, Palm Jumeirah is a hallmark of opulence, hosting an elite array of luxury villas, townhouses, apartments, and hotels. Its unique palm tree shape, consisting of a trunk, crescent, and 16 fronds, gracefully adorns the Arabian Sea coast. At Mansio at Th8, residents and guests are invited to experience the zenith of sophisticated living. This beachfront property boasts first-class amenities and facilities, along with uninterrupted views of the Arabian Gulf. Th8, strategically positioned on the West Crescent, offers sweeping views of iconic landmarks like the Dubai Marina skyline, The Atlantis, The Burj Al Arab, and Ain Dubai.
                                    Imperial Beach Club 1.5km, Aquaventure Waterpark 2.4km, Nakheel Mall 4.1km, Redwood Montessori Nursery 5.4km, Dubai Marina Mall 11km, Burj Arab 12.6km, DXB Airport 36km
