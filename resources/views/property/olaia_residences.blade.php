                    ...
                    <div class="col-lg-12">
                        <div class="title-inner ">
                            <ul class="breadcrumb">
                                ...
                                <li>Property Olaia Residences</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-2.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-2.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-2.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-3.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-3.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-3.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-5.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-6.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-6.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-6.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-7.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-7.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-7.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-8.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-8.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-8.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-2.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-3.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-5.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-6.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-7.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Olaia/Solaia-Residences-g-8.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">4443</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">1, 2, 3, 4, 5</div>
                                            </div>
                                        </div>
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">Olaia Residences by Gulf House Developers introduces a refined residential experience in one of Dubai’s most iconic destinations. Situated in Palm Jumeirah, this off-plan development by Gulf House Real Estate features a contemporary 12-floor structure, offering an exclusive selection of 1, 2, and 3-bedroom apartments alongside spacious 3 to 5-bedroom duplex residences. Handover is scheduled for October 2027, making it an exceptional investment opportunity in a premier beachfront location.


                                        <br>Designed to elevate modern living, Olaia Residences at Palm Jumeirah offers a host of world-class amenities tailored for comfort and leisure. Residents will enjoy access to a private ballroom, rooftop lounge, fitness center, swimming pools, and a dedicated kids’ area. The development also includes a mini golf course, BBQ space, and valet parking, ensuring every detail reflects convenience and luxury. Olaia Residences Palm Jumeirah Dubai redefines waterfront sophistication with a lifestyle that blends elegance, exclusivity, and contemporary design.
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Olaia Residences at Palm Jumeirah enjoys a prime location with seamless connectivity to Sheikh Zayed Road (E11), offering residents effortless access to Dubai’s key business, leisure, and retail destinations. Positioned on one of the city’s most prestigious waterfronts, Olaia Residences by Gulf House Developers combines coastal tranquility with the convenience of being minutes away from vibrant urban hubs.
