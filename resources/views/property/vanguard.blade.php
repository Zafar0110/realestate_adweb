                    ...
                    <div class="col-lg-12">
                        <div class="title-inner ">
                            <ul class="breadcrumb">
                                ...
                                <li>Property Franck Muller Vanguard</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 col-lg-7">
                                    ...
                                    <div class="swiper sw-single">
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Vanguard/g-1-1-1.jpg') }}"
                                            ...
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Vanguard/g-2-1-1.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Vanguard/g-2-1-1.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Vanguard/g-2-1-1.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Vanguard/g-4-1-1.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Vanguard/g-4-1-1.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Vanguard/g-4-1-1.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Vanguard/g-7-1-1.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Vanguard/g-7-1-1.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Vanguard/g-7-1-1.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Vanguard/g-9.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Vanguard/g-9.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Vanguard/g-9.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="swiper-slide">
                                                <a href="{{ asset('assets/images/newimages/property/Vanguard/g-10.jpg') }}"
                                                    data-fancybox="gallery" class="image-wrap d-block">
                                                    <img class="lazyload"
                                                        data-src="{{ asset('assets/images/newimages/property/Vanguard/g-10.jpg') }}"
                                                        src="{{ asset('assets/images/newimages/property/Vanguard/g-10.jpg') }}" alt="">
                                                </a>
                                            </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Vanguard/g-1-1-1.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Vanguard/g-2-1-1.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Vanguard/g-4-1-1.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Vanguard/g-7-1-1.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Vanguard/g-9.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                            <div class="swiper-slide">
                                                <div class="img-thumb-pagi">
                                                    <img src="{{ asset('assets/images/newimages/property/Vanguard/g-10.jpg') }}" alt="images">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="info flex justify-between">
                                    <div class="feature">
                                        ...
                                        <ul class="meta-list flex">
                                            ...
                                            <li class="text-1 flex"><span>1, 2</span>Bath</li>
                                    ...
                                    <div class="wrap-box">
                                        <div class="box-icon">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">7732</div>
                                            </div>
                                        </div>
                                        <div class="box-icon">
                                            <div class="icons">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="text-1 text-color-heading">1, 2 </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wrap-box">
                            ...
                            <div class="wg-property box-property-detail  spacing-1">
                                ...
                                <div class="content">
                                    <p class="description text-1 mb-10">The Franck Muller Dubai Marina Vanguard by London Gate is a masterpiece of luxury living, offering an exceptional blend of elegance and functionality. The project features fully furnished apartments ranging from studios to 3-bedroom residences, designed to cater to a sophisticated lifestyle. Residents will enjoy a seamless living experience with 8 high-speed elevators and 1 dedicated service elevator, ensuring convenience at every turn. The building boasts three podium levels, a dedicated service floor, and a vibrant retail space on the ground floor, offering a curated selection of high-end shops and services. The grand, luxurious lobby, designed with Franck Muller’s signature style, sets the tone for an unparalleled living experience in Dubai Marina.
                            ...
                            <div class="wg-property box-amenities spacing-3">
                                ...
                                <p>Franck Muller Vanguard offers an exceptional array of world-class amenities designed to enhance every aspect of modern living.
                            ...
                            <div class="wg-property single-property-map spacing-9">
                                ...
                                <iframe class="map"
                                    ...
                                    <p>Located in the vibrant Dubai Marina, Franck Muller Vanguard Dubai offers residents easy access to city conveniences and stunning views. Dubai Marina is one of the most sought-after waterfront communities in the world, renowned for its stunning skyline, vibrant lifestyle, and luxurious residential offerings. Nestled along a 3.5 km stretch of the Arabian Gulf, it offers an iconic urban experience with its gleaming towers, upscale restaurants, and trendy cafes, all set against the backdrop of a picturesque marina.
                                    </p>    
                            </div>
